...
tree_df['ratio'] = (tree_df['2024-05-04'] - tree_df['2024-05-03'])/(tree_df[tree_df['conditions']=='all']['2024-05-04'].values[0] - tree_df[tree_df['conditions']=='all']['2024-05-03'].values[0])
